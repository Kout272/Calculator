...
![Основной экран калькулятора](docs/mocups/мокап_стандартн.png)
...
![Расширенный экран](docs/mocups/мокап_научн.png)
...
## 3) Экран «Программист»
![Калькулятор программиста](docs/mocups/мокап_програм.png)
